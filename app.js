...
var batidasRouter = require('./routes/batidas'); // Import the batidas router
var folhasDePontoRouter = require('./routes/folhasDePonto'); // Import the folhasDePonto router
